...
class Predator(object):
    ...
    def attack(self):
        # Check what's around
        self.attackable_fish = [other_fish for other_fish in self.neighbouring_fish if
                                mu.is_neighbour(self, other_fish, self.environment.settings.predator_attack_radius)]
